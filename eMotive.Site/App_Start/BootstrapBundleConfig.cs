...
[assembly: WebActivator.PostApplicationStartMethod(typeof(eMotive.Site.App_Start.BootstrapBundleConfig), "RegisterBundles")]
...
namespace eMotive.Site.App_Start
{
	public class BootstrapBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include("~/Scripts/jquery*", "~/Scripts/bootstrap*"));
